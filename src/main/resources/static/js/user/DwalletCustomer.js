app.controller("Dwallet_Controller", function ($scope, $http) {
  var $wallet = ($scope.wallet = {
    ...
    getDWallet: function () {
      $http
        .get("/api/walletCustomer")
        .then((resp) => {
          this.loadDWallet = resp.data;
          // console.log("Customer: "+this.loadDWallet.user.fullname);
        })
        .catch(function (err) {
